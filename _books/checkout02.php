...
<head>
  <title>Online Books - Edit User</title>
...
<body>
  ...
  <div id="main" class="container-fluid">
	...
	<div class="form-group col-md-12">
          ...
          <input type="text" class="form-control" id="login"  name="login" value="<?php echo strip_tags($row['zip']);?>"/>
        </div>
	<div class="form-group col-md-12">
          <label for="Add an Description">Password</label>
          <input type="text" class="form-control" id="senha"  name="senha" value="<?php echo strip_tags($row['zip']);?>"/>
        </div>
	</div>
